                                ...
                                <View className="border-b border-gray-200 pb-6">
                                    <View className="flex-row justify-between items-center mb-4">
                                        <View>
                                            ...
                                            <Text className="text-sm text-gray-500">Bảo vệ tài khoản bằng xác thực 2
                                                lớp</Text>
                                        </View>
                                        <TouchableOpacity
                                            className="px-4 py-2 bg-blue-50 rounded-md"
                                ...
                                <View className="border-b border-gray-200 pb-6">
                                    <View className="flex-row justify-between items-center mb-4">
                                        <View>
                                            ...
                                            <Text className="text-sm text-gray-500">Xem và quản lý các thiết bị đã đăng
                                                nhập</Text>
                                        </View>
                                        <TouchableOpacity
                                            className="px-4 py-2 bg-blue-50 rounded-md"
                                ...
                                <View>
                                    <View className="flex-row justify-between items-center">
                                        <View>
                                            ...
                                            <Text className="text-sm text-gray-500">Đăng xuất khỏi tất cả thiết
                                                bị</Text>
                                        </View>
                                        <TouchableOpacity
